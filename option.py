...
class Options():
    def __init__(self):
        ...
        test_arg.add_argument("--test_batch_size", type=int, default=64, help="batch size when test")
        ...
        test_arg.add_argument("--gpu", type=int, default=1, help="whether to use gpu")

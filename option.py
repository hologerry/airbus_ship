...
class Options():
    def __init__(self):
        ...
        train_arg.add_argument("--epochs", type=int, default=31, help="number of epochs")
        train_arg.add_argument("--batches_per_epoch", type=int, default=int((11256*0.8)//32), help="number of batches per epoch")
        ...
        train_arg.add_argument("--valid_batch_size", type=int, default=32, help="number of validation images in one batch to use")
        train_arg.add_argument("--valid_batches", type=int, default=int((11256*0.2)//32), help="number of validation batches in one batch to use")
        ...
        train_arg.add_argument("--summary_dir", type=str, default="summary")
        ...
        test_arg.add_argument("--test_batch_size", type=int, default=10, help="batch size when test")
        test_arg.add_argument("--test_batches", type=int, default=30//10, help="number of test batches")

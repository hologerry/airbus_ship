...
class Options():
    def __init__(self):
        ...
        train_arg.add_argument("--train_set_dir", type=str, default="train", help="path to train set")
        ...
        train_arg.add_argument("--cuda", type=int, default=1, help="")

        test_arg = subparsers.add_parser("test", help="parser for testing arguments")
        test_arg.add_argument("--test_set_dir", type=str, default="test", help="path to test set")
